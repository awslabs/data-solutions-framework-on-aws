...
cdk.CfnOutput(stack, "mskArn",
    value=msk.cluster.get_att_string("Arn")
)
  ```
...
:::warning
If you provide your own MSK configuration, be sure to follow security [MSK best practices](https://docs.aws.amazon.com/msk/latest/developerguide/security.html) 
