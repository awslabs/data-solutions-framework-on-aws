...
class ExampleDefaultAthenaWorkGroupStack extends Stack {
  ...
  ```python
class ExampleDefaultAthenaWorkGroupStack(Stack):
...
class ExampleUserBucketAthenaWorkGroupStack extends Stack {
  ...
  ```python
class ExampleUserBucketAthenaWorkGroupStack(Stack):
    def __init__(self, scope, id):
        super().__init__(scope, id)

        user_results_bucket = Bucket(self, "UserResultsBUcket")
        user_data_key = Key(self, "userDataKey")
...
class ExampleSparkAthenaWorkGroupStack extends Stack {
  ...
  ```python
class ExampleSparkAthenaWorkGroupStack(Stack):
    def __init__(self, scope, id):
        super().__init__(scope, id)
...
class ExamplePropertiesAthenaWorkGroupStack extends Stack {
  ...
  ```python
class ExamplePropertiesAthenaWorkGroupStack(Stack):
    def __init__(self, scope, id):
        super().__init__(scope, id)
...
class ExampleGrantAthenaWorkGroupStack extends Stack {
  ...
  ```python
class ExampleGrantAthenaWorkGroupStack(Stack):
    def __init__(self, scope, id):
        super().__init__(scope, id)

        athena_example_role = Role(self, "AthenaWgExampleRole",
