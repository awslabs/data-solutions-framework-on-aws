...
package_example()
{
  ...
  cd $EXAMPLE_DIR
  # remove the projen header and append 'cdklabs.aws-data-solutions-framework'
  find . -type f -name 'requirements.txt' | while read file; do sed -i '1d; $a cdklabs.aws-data-solutions-framework' "$file"; done
