...
first_api.add_none_data_source("FirstSourceDS",
    name=cdk.Lazy.string({def produce(self): return "FirstSourceDS"})
)
...
second_api.add_none_data_source("SecondSourceDS",
    name=cdk.Lazy.string({def produce(self): return "SecondSourceDS"})
)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"source_api": "sourceApi", "merge_type": "mergeType"},
)
class SourceApi:
    def __init__(
        self,
