...
NagSuppressions.addResourceSuppressionsByPath(
  stack,
  '/Stack/RedshiftWorkgroup/DataSharingDataAccess/InterfaceVpcEndpointSecurityGroup/Resource',
...
NagSuppressions.addResourceSuppressionsByPath(stack,
  [
    '/Stack/RedshiftWorkgroup/DataSharing/CrDataShareProvider',
    '/Stack/RedshiftWorkgroup/DataSharingDataAccess/CrProvider',
    '/Stack/DefaultNamespace/Provider',
    '/Stack/DefaultNamespace/CreateSLR/Provider',
  ],
  [
