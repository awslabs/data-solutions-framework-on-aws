...
class ExampleOpenSearchApiStackMethodCall extends cdk.Stack {
...
new ExampleOpenSearchApiStackMethodCall(app, 'ExampleOpenSearchApiStandaloneStack', { env: {region:'us-east-1'} });