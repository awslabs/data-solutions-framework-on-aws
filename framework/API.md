...
| <code><a href="#aws-dsf.governance.DataCatalogDatabaseProps.property.crawlerRole">crawlerRole</a></code> | <code>aws-cdk-lib.aws_iam.Role</code> | When passed, the crawler that would be created when `autoCrawl` is set to `True` would used this role. |
...
| <code><a href="#aws-dsf.processing.PySparkApplicationPackageProps.property.assetUploadRole">assetUploadRole</a></code> | <code>aws-cdk-lib.aws_iam.Role</code> | When passed, the Lambda function would used this role as its execution role. |
...
```typescript
public readonly assetUploadRole: Role;
```
