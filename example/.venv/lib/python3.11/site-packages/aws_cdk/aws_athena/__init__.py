    ...
    class ResultConfigurationUpdatesProperty:
        def __init__(
            ...
            *,
            ...
            :param acl_configuration: Indicates that an Amazon S3 canned ACL should be set to control ownership of stored query results.
            :param encryption_configuration: If query results are encrypted in Amazon S3, indicates the encryption option used (for example, SSE-KMS or CSE-KMS) and key information.
            :param expected_bucket_owner: The AWS account ID of the owner of S3 bucket where query results are stored.
            ...
            :param remove_acl_configuration: 
            :param remove_encryption_configuration: 
            :param remove_expected_bucket_owner: 
