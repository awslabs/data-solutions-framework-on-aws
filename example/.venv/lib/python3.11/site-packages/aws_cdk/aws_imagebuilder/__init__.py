...
class CfnImage(
    ...
    def __init__(
        ...
        *,
        ...
        :param image_scanning_configuration: Contains settings for Image Builder image resource and container image scans.
    ...
    class EcrConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            :param container_tags: Tags for Image Builder to apply the output container image that is scanned. Tags can help you identify and manage your scanned images.
    ...
    class ImageScanningConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            :param ecr_configuration: Settings for Image Builder to configure the ECR repository and output container images that are scanned.
            :param image_scanning_enabled: This sets whether Image Builder keeps a snapshot of the vulnerability scans that Amazon Inspector runs against the build instance when you create a new image.
...
class CfnImagePipeline(
    ...
    def __init__(
        ...
        *,
        ...
        :param image_scanning_configuration: Determines if tests should run after building the image. Image Builder defaults to enable tests to run following the image build, before image distribution.
