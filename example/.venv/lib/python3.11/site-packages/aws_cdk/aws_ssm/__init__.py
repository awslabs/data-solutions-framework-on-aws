...
class CfnAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        :param wait_for_success_timeout_seconds: *(No longer supported)* This property is no longer supported for the ``AWS::SSM::Association`` resource. You should not include it when defining this resource in your AWS CloudFormation template. Doing so can result in inaccuracies in AWS CloudFormation resource drift detection.
        '''
        if __debug__:
