...
from adsf_example.main import MyStack, EmrApplicationStackFactory
...
def test_factory_defined(template):
  factory = EmrApplicationStackFactory()
  assert not factory is None
